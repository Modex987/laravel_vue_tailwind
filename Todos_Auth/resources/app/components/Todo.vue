<template>
    <div id="todo" :class="{'bg-opacity-25': todo.status}" class="m-1 flex flex-col  border-2 absolute rounded bg-blue-900 text-white" ref="draggableContainer">
        <div class="flex justify-between p-1 cursor-move" @mousedown="dragMouseDown">
            <div>
            ...
            <div>
                <button @click="toggleEditMode" class="hover:text-black cursor-pointer">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path></svg>
                </button>
                <button class="hover:text-black ml-2 cursor-pointer">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"></path></svg>
                </button>
                <button @click="toggleStatus" class="hover:text-black ml-2 cursor-pointer">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4"></path></svg>
                </button>
            </div>
        </div>
        <div class="border-t-2 border-b-2 p-1 bg-gray-300 text-gray-900 flex-grow flex justify-items-stretch">
            <p v-if="!isEditMode" class="break-words">
                {{todo.body}}
            </p>
            <textarea v-if="isEditMode" v-model="todo.body">
            </textarea>
        </div>
